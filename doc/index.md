...
1. Присваивание и внутреннее состояние объектов
  ...
  * [Упражнение 3.28](./chapter03/ex_3_28.md) Функциональный элемент ИЛИ (or-gate)
  * [Упражнение 3.29](./chapter03/ex_3_29.md) Альтернативное определение элемента ИЛИ с помощью элемента И и инверторов.
  * [Упражнение 3.30](./chapter03/ex_3_30.md) Каскадный n-битный сумматор.
